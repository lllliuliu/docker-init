...
var rootCmd = &cobra.Command{
	Use:   "docker-init",
	Short: "Initializa the docker compose.",
	Long: `Initializa the docker compose, contains multiple subcommands.
	
Such as initialize network and generate the .env file, etc...`,
}
